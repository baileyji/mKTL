...
def save(store, uuid, req=None, pub=None):
    ...
    if pub is not None:
        ...
        if os.path.exists(pub_filename) and not os.access(pub_filename, os.W_OK):
    ...
    if req is not None:
        ...
        if os.path.exists(req_filename) and not os.access(req_filename, os.W_OK):
