...
class Pending:
    ...
    def partial(self, response=None, bulk=None):
        ...
        if self.rep is not None and self.bulk is not None:
            ...
            return False  #TODO potential bugfix --JIB
...
class Server:
    ...
    worker_count = 10
    #TODO the default argument in this class constructor is mutable, that is likely a VERY BAD THING (TM), and if not,
    # a VERY CLEVER THING (TM)...and thus likely to result in others making mistakes
