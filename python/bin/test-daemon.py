...
def main():
    ...
    store = MarkPie(name='mpie', config='cloned')
...
class MarkPie(mKTL.daemon.store):
    ...
    def setup(self):
        ...
        for key in keys:
            ...
            item = mKTL.daemon.item(self, key)
...
class SequenceInteger(mKTL.daemon.item):
    ...
    def req_refresh(self):
        ...
        mKTL.daemon.item.req_refresh(self)
